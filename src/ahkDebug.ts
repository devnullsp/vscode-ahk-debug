...
/**
 * This interface describes the ahk-debug specific launch attributes
 * (which are not part of the Debug Adapter Protocol).
 * The schema for these attributes lives in the package.json of the ahk-debug extension.
...
export class ahkDebugSession extends LoggingDebugSession {
	...
	private createSource(filePath: string): Source {
		return new Source(basename(filePath), this.convertDebuggerPathToClient(filePath), undefined, undefined, 'ahk-adapter-data');
	}
}
