...
export class ahkRuntime extends EventEmitter {
	...
	// maps from sourceFile to array of ahk breakpoints
	...
	public start(program: string, stopOnEntry: boolean) {
		console.log("Iniciando el proceso "+program);
	...
	public setBreakPoint(path: string, line: number) : ahkBreakpoint {
		...
		const bp = <ahkBreakpoint> { verified: false, line, id: this._breakpointId++ };
